    ...
    public class PersonaRepository {
        ...
        public void Guardar (Persona persona) {
            using (var comand = _connection.CreateCommand ()) {
                comand.CommandText = @"Insert Into Persona (Identificacion,Nombre,Edad, Sexo, Pulsacion) 
                                        values (@Identificacion,@Nombre,@Edad,@Sexo,@Pulsacion)";
                comand.Parameters.AddWithValue ("@Identificacion", persona.Identificacion);
                comand.Parameters.AddWithValue ("@Nombre", persona.Nombre);
                comand.Parameters.AddWithValue ("@Sexo", persona.Sexo);
                comand.Parameters.AddWithValue ("@Edad", persona.Edad);
                comand.Parameters.AddWithValue ("@Pulsacion", persona.Pulsacion);
